...
Во время подкаста <a href = https://kidai.mave.digital>‘КИдай’</a> возник спор, стоит ли вообще давать четкое определение контактной импровизации, каким оно могло бы быть, связаны ли политика и телесная практика, и какое будущее может быть у КИ.

Мы решили задать эти вопросы <a href = https://chat.openai.com/>чату GPT</a>:
